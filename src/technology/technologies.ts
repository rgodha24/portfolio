...
export const technologies = ["unocss", "tailwind", "rust", "tauri", "svelte", "astro", "nextjs", "polodb", "sveltekit", "trpc", "prisma"] as const;
...
export const techIcons = {
  ...
  nextjs: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTH1MuogmP0rG5nAkxbm8co2ZLwQsAyiR54CZjf68Nowg&s",
  astro: "https://astro.js.org/astro.png",
  polodb: "https://www.polodb.org/_next/image?url=%2Fstatic%2Flogo.png&w=256&q=75",
  sveltekit: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGo1SbZl59nmMN7CvjT3HO5-xkjm3swgj3eJXM33pL&s",
  trpc: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPCxjn29gZ2JDsOHAWLBOgzGsKvLjCVUz5T_zcFP4&s",
  prisma: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKIL_5aGs-hRBgV1f0pV8NrOCTTIJkaCvA-RwuawS1&s"
} as const satisfies Record<Technologies, string>;
